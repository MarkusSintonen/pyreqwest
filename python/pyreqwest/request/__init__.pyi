...
from pyreqwest.types import Stream, UrlType, Params
...
class RequestBuilder:
    ...
    def query(self, query: Params) -> Self: ...
    def form(self, form: Params) -> Self: ...
    def extensions(self, extensions: Mapping[str, Any]) -> Self: ...
