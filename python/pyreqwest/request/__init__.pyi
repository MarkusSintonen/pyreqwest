...
class Request:
    ...
    def set_header(self, name: str, value: str) -> str | None: ...
...
class RequestBuilder:
    ...
    def query(self, query: Sequence[tuple[str, Any]] | Mapping[str, Any]) -> Self: ...
    def form(self, form: Sequence[tuple[str, Any]] | Mapping[str, Any]) -> Self: ...
