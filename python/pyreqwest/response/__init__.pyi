...
from pyreqwest.types import BlockingStream, ExtensionsType, HeadersType, Stream
...
class BlockingResponse(BaseResponse):
...
class BlockingResponseBuilder(BaseResponseBuilder):
    def __init__(self) -> None: ...
    def build(self) -> BlockingResponse: ...
